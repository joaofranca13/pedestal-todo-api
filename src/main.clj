...
(def accepteed (partial response 202))
...
(def routes
  (route/expand-routes
    #{["/todo" :post [db-interceptor list-create]]
      ...
      ["/todo/:list-id/:item-id" [entity-render list-item-view db-interceptor]]
      ["/todo/:list-id/:item-id" :post echo :route-name :list-item-update]
